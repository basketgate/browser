...
public class FloatingWalmartButtonBehavior extends CoordinatorLayout.Behavior<FloatingActionButton> implements AppBarLayout.OnOffsetChangedListener {
    ...
    public FloatingWalmartButtonBehavior(Context context, AttributeSet attrs) {
        super();
    ...
    private void showButton() {
        Log.d("FloatingActionBBehavior","Dima : showButton ");
        animate(button, false);
    }

    private void hideButton() {
        Log.d("FloatingActionBBehavior","Dima : hideButton ");
        animate(button, true);
    }
